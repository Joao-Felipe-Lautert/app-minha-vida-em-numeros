#  Diário de Treinos F1🏎️ Este é um projeto de aplicativo mobile desenvolvido como parte da disciplina de Programação Mobile, do curso técnico de Desenvolvimento de Sistemas, lecionada pelo Professor Artur Scolari. O objetivo é criar um diário pessoal para registrar e acompanhar métricas de treino diárias, com dados salvos de forma persistente.

## Sobre o Projeto 📝
O "Diário de Treinos F1" é um aplicativo para acompanhamento de periodo de treinos de um piloto. Ele permite que o usuário registre diariamente a quantidade de horas realizadas de simulador, de descanço, de cardio e de aerobico. O app também oferece funcionalidades de ordenação dos registros e visualização gráfica da evolução.
...
- [x] Validação para não permitir a entrada de dados negativos, ou que passem de 24Hrs.
